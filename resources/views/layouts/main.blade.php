        ...
        <section class="topnav__navbar">
            ...
            @else
                @if (Auth::user()->role === 'Owner')
                    <a href="{{ route('pets.index') }}" class="topnav__navbar__button">Mijn huisdieren</a>
            ...
            <!-- Admin Login knop met icoon -->
            <a href="{{ route('admin.login') }}" class="topnav__navbar__button admin-login">
                <i class="fa fa-user admin-icon"></i> Admin Login
            </a>
        </section>
    </nav>
