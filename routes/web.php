...
Route::prefix('admin')->middleware('auth')->group(function () {
    ...
    Route::put('/users/{id}/block', [AuthController::class, 'blockUser'])->name('admin.users.block');
    Route::put('/users/{id}/unblock', [AuthController::class, 'unblockUser'])->name('admin.users.unblock');
    Route::delete('/requests/{id}', [AuthController::class, 'deleteRequest'])->name('admin.requests.delete');
